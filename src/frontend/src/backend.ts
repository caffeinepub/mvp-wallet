...
import type { Transaction as _Transaction, TransactionType as _TransactionType, UserProfile as _UserProfile, UserRole as _UserRole, WalletState as _WalletState } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async depositCofrinho(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: bigint;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.depositCofrinho(arg0);
    ...
    async getWalletState(): Promise<WalletState> {
        if (this.processError) {
            try {
                const result = await this.actor.getWalletState();
                return from_candid_WalletState_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async sendPix(arg0: string, arg1: bigint, arg2: string): Promise<{
        __kind__: "ok";
        ok: bigint;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.sendPix(arg0, arg1, arg2);
                return from_candid_variant_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async simulateReceivePix(arg0: bigint, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.simulateReceivePix(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async withdrawCofrinho(arg0: bigint): Promise<{
        __kind__: "ok";
        ok: bigint;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.withdrawCofrinho(arg0);
                return from_candid_variant_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_WalletState_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WalletState): WalletState {
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        cofrinhoBalance: value.cofrinhoBalance,
        balance: value.balance,
        transactions: from_candid_vec_n9(_uploadFile, _downloadFile, value.transactions)
    };
}
function from_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "receivedPix" in value ? TransactionType.receivedPix : "cofrinhoDeposit" in value ? TransactionType.cofrinhoDeposit : "cofrinhoWithdrawal" in value ? TransactionType.cofrinhoWithdrawal : "sentPix" in value ? TransactionType.sentPix : value;
}
